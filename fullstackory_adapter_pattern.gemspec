...
Gem::Specification.new do |spec|
  spec.name          = "fullstackory_adapter_pattern"
  spec.version       = FullstackoryAdapterPattern::VERSION
  ...
  spec.homepage      = "https://github.com/full-stackory/fullstackory_adapter_pattern"
  ...
  spec.add_dependency "faker", "~> 2.10.0"
end
